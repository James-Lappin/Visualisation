...
mongo visualisation --eval "db.createUser({user: 'hideout', pwd: 'gettoglass', roles: [ 'dbOwner' ]})"
mongo visualTesting --eval "db.createUser({user: 'testing', pwd: 'helloworld', roles: [ 'dbOwner' ]})"
