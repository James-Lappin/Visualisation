...
namespace Visualisation.Web
{
	...
	public class ApplicationUserManager : UserManager<ApplicationUser>
	{
		...
		public ApplicationUserManager()
			: base(new UserStore<ApplicationUser>(new ApplicationUserRepository().Users))
		{
		}
	...
	public class ApplicationRoleManager : RoleManager<IdentityRole>
	{
		...
		{
			var manager = new ApplicationRoleManager(new RoleStore<IdentityRole>(new IdentityRoleRepository().Roles));
	...
	public class SignInHelper
	{
		...
		private async Task<SignInStatus> SignIn(ApplicationUser user, bool isPersistent)
		{
